...
PSF=PSF(201:301,301:401);   % PSF最大值点250,351
%% 星云    101.jpg
clear Original
...
temp_Dirtymap_1=temp_Dirtymap_1(51:151,51:151);
...
temp_Dirtymap_2=temp_Dirtymap_2(51:151,51:151);
...
temp_Dirtymap_3=temp_Dirtymap_3(51:151,51:151);
...
temp_Dirtymap_4=temp_Dirtymap_4(51:151,51:151);
% figure;pcolor(temp_Dirtymap_3);shading interp;colorbar;
% max_3=max(max(temp_Dirtymap_3))
...
temp_Dirtymap_5=temp_Dirtymap_5(51:151,51:151);
% figure;pcolor(temp_Dirtymap_3);shading interp;colorbar;
% max_3=max(max(temp_Dirtymap_3))
...
yuzhi5= 0.05*max(max(temp_Dirtymap_5)) ; %迭代截止阈值
...
I_1=conv2(model_1,b);
I_1=I_1(51:151,51:151);

I_2=conv2(model_2,b);
I_2=I_2(51:151,51:151);

I_3=conv2(model_3,b);
I_3=I_3(51:151,51:151);

I_4=conv2(model_4,b);
I_4=I_4(51:151,51:151);

I_5=conv2(model_5,b);
I_5=I_5(51:151,51:151);
...
figure;pcolor(Dirtymap);shading interp;colorbar; title('脏图');%caxis([0 10]);
% figure;pcolor(model_1);shading interp;colorbar;title('模型图1'); %caxis([0 10]);
% figure;pcolor(model_2);shading interp;colorbar;title('模型图2'); %caxis([0 10]);
% figure;pcolor(model_3);shading interp;colorbar;title('模型图3'); %caxis([0 10]);
% figure;pcolor(model_4);shading interp;colorbar;title('模型图4'); %caxis([0 10]);
% figure;pcolor(model_5);shading interp;colorbar;title('模型图5'); %caxis([0 10]);
% figure;pcolor(temp_Dirtymap_1);shading interp;colorbar;title('残图1'); %caxis([0 10]);
% figure;pcolor(temp_Dirtymap_2);shading interp;colorbar;title('残图2'); %caxis([0 10]);
% figure;pcolor(temp_Dirtymap_3);shading interp;colorbar;title('残图3'); %caxis([0 10]);
...
figure;pcolor(I_1);shading interp;colorbar;title('结果图1'); %caxis([0 10]);
figure;pcolor(I_2);shading interp;colorbar;title('结果图2'); %caxis([0 10]);
figure;pcolor(I_3);shading interp;colorbar;title('结果图3'); %caxis([0 10]);
figure;pcolor(I_4);shading interp;colorbar;title('结果图4'); %caxis([0 10]);
figure;pcolor(I_5);shading interp;colorbar;title('结果图5'); %caxis([0 10]);
figure;pcolor(I);shading interp;colorbar;title('结果图'); caxis([0 200]);
